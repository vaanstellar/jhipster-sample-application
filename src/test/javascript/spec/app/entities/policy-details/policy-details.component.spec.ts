...
import { PolicyDetailsComponent } from 'app/entities/policy-details/policy-details.component';
...
describe('Component Tests', () => {
  describe('PolicyDetails Management Component', () => {
    let comp: PolicyDetailsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PolicyDetailsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.policyDetails[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
